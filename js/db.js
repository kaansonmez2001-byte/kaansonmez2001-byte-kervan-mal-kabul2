const KDB=(()=>{const NAME='kervan-mal-kabul-web';const VERSION=4;let p;
...
mk('settings','key');mk('syncQueue');};r.onsuccess=()=>res(r.result);r.onerror=()=>rej(r.error)});return p}
...
return{open,get,all,put,add,del,clear,indexAll,setting,setSetting,log}})();
