...
declare oldrow jsonb; result jsonb; cols text; vals text; sets text; clean jsonb; allowed text[]; begin
 ...
 clean:=clean||jsonb_build_object('local_id',p_key,'last_mutation',p_mutation);
