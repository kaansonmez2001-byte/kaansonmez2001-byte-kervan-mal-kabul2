const CACHE='kervan-mal-kabul-v15-receipt-edit';
const LOCAL=['/','/index.html','/assets/app.css','/js/cache.js?v=15','/js/db.js?v=15','/js/staff.js?v=15','/js/sync.js?v=15','/js/app.js?v=15','/manifest.webmanifest'];
