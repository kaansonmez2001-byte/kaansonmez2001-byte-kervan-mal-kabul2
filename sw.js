const CACHE='kervan-mal-kabul-v24-login-recovery';
const LOCAL=['/','/index.html','/assets/app.css','/js/cache.js?v=24','/js/db.js?v=24','/js/staff.js?v=24','/js/sync.js?v=24','/js/accounting.js?v=24','/js/app.js?v=24','/manifest.webmanifest'];
